...
int yoloV3()
{
	...
	VideoCapture cap("D:\\opencv\\opencv4.0\\opencv4.0.0\\sources\\samples\\data\\vtest.avi");	//打开一个视频

	if (!cap.isOpened())return -1;


	//coco数据集的名称文件，80类
	string classesFile = "D:\\opencv_picture_test\\神经网络\\coco.names";
	//yolov3网络模型文件
	String yolov3_model = "D:\\opencv_picture_test\\神经网络\\yolov3.cfg";
	//权重
	String weights = "D:\\opencv_picture_test\\神经网络\\yolov3.weights";
...
int openpose()
{
	...
	String modelTxt = "D:\\opencv_picture_test\\神经网络\\openpose_pose_coco.prototxt";
	String modelBin = "D:\\opencv_picture_test\\神经网络\\openpose_caffe_models\\caffe_models\\pose\\coco\\pose_iter_440000.caffemodel";
	...
	VideoCapture cap;
	cap.open("D:\\opencv_picture_test\\神经网络\\开合跳_55个.avi");
