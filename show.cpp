...
int mouseROI()
{
	cv::Mat srcMat = imread("D:\\opencv_picture_test\\darling in the franxx\\02字.png", 1);
	cv::Mat dstMat;
...
int dftDemo() {
	...
	cv::Mat srcMat = imread("D:\\opencv_picture_test\\darling in the franxx\\02字.png", 0);
...
{
	cv::Mat dst;
	cv::Mat src = imread("D:\\opencv_picture_test\\darling in the franxx\\02字.png", 0);
